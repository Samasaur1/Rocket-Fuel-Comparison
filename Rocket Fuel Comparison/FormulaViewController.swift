...
class FormulaViewController: NSViewController {
    override func viewDidLoad() {
        explanationLabel.stringValue = "Given t is the thrust of a fuel, s is the specific impulse, and p is the price, the following formula is used to calculate score:"
    }
